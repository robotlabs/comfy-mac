...
| File | Cos'è |
|---|---|
| **`Wan2.2_I2V_reel_exposed_v3.json`** | ⭐ **QUESTO.** Tutto pronto: parametri esposti nel pannello, valori giusti bakati, RIFE ×2 (fluido), estrazione last-frame PNG. |
...
### 3. Usa il workflow
- Refresh/restart ComfyUI → trascina **`Wan2.2_I2V_reel_exposed_v3.json`**.
